      <div id="stats">
        ...
        <ul>
          ...
          <li>Posted: <a href="/post?tags=date%3A<?php echo date('Y-m-d', datetime_to_timestamp($post->created_at)) ?>"><?php echo time_ago_in_words(date('Y-m-d H:i:s', datetime_to_timestamp($post->created_at))) ?> ago</a> by <a href="/user/show/<?php echo $post->user_id ?>"><?php echo $post->author ?></a></li>
