<?php
if (User::$current->is('<=20') && Request::$params->commit == "Post" && Comment::$_->count(array('conditions' => array("user_id = ? AND created_at > ?", User::$current->id, gmd_math('sub', '1H'))) >= CONFIG::member_comment_limit)) {
...
$comment = Comment::$_->blank(Request::$params->comment);
